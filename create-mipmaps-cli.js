...
const main = async (inputFile, outputFile, target, noLevels) => {
...
const [_a, _b, inputFile, outputFile, targetX, targetY, noLevels] = process.argv;

main(inputFile, outputFile, {x: targetX * 1024, y: targetY * 1024}, noLevels);